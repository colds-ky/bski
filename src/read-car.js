...
import { readCar } from './decodeatc/car/reader';
import { decode as decodeCBOR2 } from './decodeatc/cbor/decode';
import { decode as decodeCID2 } from './decodeatc/cbor/cid';
import { toBase32 } from './decodeatc/multibase/base32';
 ...
 * @returns {Generator<import('./firehose').FirehoseRecord[] & { parseTime: number } | undefined>}
 */
export function* sequenceReadCAR2(messageBuf, did) {
  if (typeof messageBuf === 'string')
    [messageBuf, did] = /** @type {[any, any]} */([did, messageBuf]);
